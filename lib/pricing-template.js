...
export function renderPricingHtml({ listPrice, discountedPrice, finalPrice }) {
...
<body>
  <div class="left">
    ...
    <div class="row"><b>Profiles:</b> X,Y, Z</div>
    <div class="row"><b>Includes:</b></div>
    <ul>
      <li>Premium PartySlate Profile placement</li>
      <li>Photo Hub sales enablement tools</li>
      <li>Integrations</li>
      <li>Additional Marketing Activities</li>
      <li>Onboarding, support, and performance reviews</li>
    </ul>
    <div class="row"><b>Discounting:</b> ${discountPct}% multi-location group discount applied</div>
    <div class="row"><b>Billing:</b> Annual or quarterly options available</div>
  </div>
  ...
  <div class="footer"><span class="party">PARTY</span><span class="slate">SLATE</span></div>
</body>
</html>`
}
