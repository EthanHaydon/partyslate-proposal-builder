...
export function renderComparisonHtml({
  ...
  const todayCaption = buildCaption(t)
...
<body>
  ...
  <div class="cards">
    <div class="card today">
      ...
      ${todayCaption ? `<div class="spend-caption">${esc(todayCaption)}</div>` : ''}
      ${todayBullets ? `<div class="divider"></div><ul class="bullets">${todayBullets}</ul>` : ''}
    </div>
    ...
    <div class="card proposed">
      ...
      ${proposedDelta ? `<div class="spend-caption delta">${esc(proposedDelta)}</div>` : ''}
      ${proposedBullets ? `<div class="divider"></div><ul class="bullets">${proposedBullets}</ul>` : ''}
    </div>
  </div>
</body>
</html>`
