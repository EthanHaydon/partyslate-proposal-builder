...
export function prepareExecutiveGroupDeal(body, errors) {
  ...
  descriptors.push(
    ...
    { kind: 'dynamic', pngKey: 'pricing',   canvasIdx: 11, bg: 'white' },    // 10 Investment Summary (replaces PPTX slide11.xml)
    { kind: 'static',  sourceIdx: 10,       canvasIdx: 9,  photoSlot: 3 },   // 11 Marketing Activities (PPTX slide9.xml)
    { kind: 'static',  sourceIdx: 11,       canvasIdx: 12 },                 // 12 Trusted
